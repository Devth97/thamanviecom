...
export default function WhatsAppCTA() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 md:bottom-6 right-4 md:right-6 z-50 flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 transition-shadow hover:shadow-xl"
    >
