    ...
    <>
      ...
      >
        <div className="flex items-stretch">
          ...
          {/* Account — Shopify customer portal (real orders, addresses) */}
          <a
            href={SHOPIFY_ACCOUNT_URL}
            className="flex-1 flex flex-col items-center justify-center py-2 gap-1 text-[10px] font-medium tracking-wide text-[#555] transition-colors"
          >
